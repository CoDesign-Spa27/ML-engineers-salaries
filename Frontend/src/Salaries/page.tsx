...
const MainPage = () => {
  ...
  return (
    ...
    <p className="text-center uppercase text-4xl py-3 font-black text-neutral-50">
    ML Engineers Salaries and Job Title.
      </p>
      <p className=" capitalize text-md pb-6 text-center ">Click on the year to see Job Details</p>
      <MainTable columns={columns} data={processedData} onRowClick={handleRowClick} />
      ...
      {selectedYear && showPopover && (
        ...
        >
          ...
          <button
            ...
            className="mt-4 py-1 px-4 bg-pink-500 rounded-lg text-white hover:bg-pink-600"
          >
            Close
          </button>
        </motion.div>
